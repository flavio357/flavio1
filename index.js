...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=5581983678841:+55 81 98367-8841\n' 
            + 'END:VCARD' 
prefix = '!'
blocked = []          
...
const config = {
    XBOT: 'ᏴϴͲ ீ͜ৡৢ͜͡𝑭𝑳𝑨𝑽𝑰𝑶 𝑫𝑶𝑴𝑰𝑵𝑨', 
    instagram: 'OFF', 
    nomer: 'wa.me/5581983678841',
    youtube: 'https://youtube.com/channel/UCzBxPxlC38-33Hw1m05_o8Q', 
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: '❬❗❭GUENTA AI PORRA TO FAZENDO 🤙🤬❬❗❭',
				success: '️❬ ✔ ❭ PRONTINHO 🖤',
				error: {
			...
			const ownerNumber = ["5581983678841@s.whatsapp.net"] 
			...
			switch(command) {
                ...
                case 'reportarbug':
                    ...
                    client.sendMessage('5581983678841@s.whatsapp.net', options, text, {quoted: mek})
            ...
            case 'criador':
            case 'keke':
                  client.sendMessage(from, {displayname: "Flavio Domina", vcard: vcard}, MessageType.contact, { quoted: mek})
       client.sendMessage(from, 'Este é o número do meu criador ^-^ ',MessageType.text, { quoted: mek} )
           ...
           case 'rebaixar':
			...
			case 'remover':
				...
				case 'clonar':
					if (!isGroup) return reply(mess.only.group)
					if (!isOwner) return reply(' *quem e tu porra? ?') 
